...
// Process data cycle time in microseconds. This value is written to the drives
// as the expected loop period (object 0x60C2), so it must match the real cycle
// time. Do not go below 1000 us with the cooperative scheduler of Circle.
#define ETHERCAT_CYCLE_TIME_US	2000
